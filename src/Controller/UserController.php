...
class UserController extends AbstractController
{
    ...
    {
        return $this->render('@AcMarcheApi/user/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('@AcMarcheApi/user/new.html.twig', [
            'user' => $user,
    ...
    {
        return $this->render('@AcMarcheApi/user/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user): Response
    {
        ...
        return $this->render('@AcMarcheApi/user/edit.html.twig', [
            'user' => $user,
            'form' => $form->createView(),
        ]);
    }
